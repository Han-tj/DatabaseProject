<template>
    <div>
        <div class="tweets block"> <!-- TWEETS (MIDDLE-CONTAINER) -->
                    <h2 align="center" class="titular"><i class="fa fa-plus-square" aria-hidden="true"></i>&nbsp;&nbsp;&nbsp;健康报告</h2>
                    <div class="tweet first">
                        <p><a class="time-ago scnd-font-color" href="#20">BMI状况</a></p>
						<p>{{this.ADVICE1}}</p>
                    </div>
                    <div class="tweet first">
                        
						<p><a class="time-ago scnd-font-color" href="#20">心率状况</a></p><p>{{this.ADVICE2}}</p>
                    </div>
                    <div class="tweet first">
                        
						<p><a class="scnd-font-color" href="#20">血压状况</a></p><p>{{this.ADVICE3}}</p>
                    </div>
                </div>
    </div>
</template>

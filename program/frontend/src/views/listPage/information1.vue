  ...
  <div class="main-container">
      <div class="left-container container">
            ...
            <header class="block">
              ...
              <inPageAppointments ref="listItem" :subReservationsList="ReservationsData"></inPageAppointments>
            </div>
...
import { getReservationsFun } from '@/service/userService'
  ...
  data(){
      ...
      paient_created(){
		  console.log(this.$store.state.userId)
              getPaiInoFun(
				...
				this.$store.commit('editInquiryPatientName',this.PaiIno.PATI_NAME)
                }).catch(err=>{
                  console.log(err);
              });
          },
		  getReservationsList(){
              getReservationsFun(
                ...
                let t=1;
				  ...
				  console.log(this.$store.state.userId)
                  this.ReservationsData = this.ReservationsList;
                }).catch(err=>{
                  console.log(err);
              });
    ...
    //向表单信息添加新信息
       postPaiInoFun({
		...
		tel:mes.phone,
		identification:this.PaiIno.IDENTIFICATION,
		sex:this.PaiIno.SEX
      }).then(res=>{

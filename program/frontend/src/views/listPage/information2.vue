  ...
  <div class="main-container">
      <div class="left-container container">
            ...
            <header class="block">
              ...
              <inPageHospital ref="listItem" :subOfflineAppFunList="OfflineAppFunData"></inPageHospital>
            </div>
...
import { getOfflineAppFun } from '@/service/userService'
		  ...
		  getOfflineAppList(){
              getOfflineAppFun(
                ...
                let t=1;
                  ...
                  console.log(res);
                  this.OfflineAppFunData = this.OfflineAppFunList;
                }).catch(err=>{
                  console.log(err);
              });
          },

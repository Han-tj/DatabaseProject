...
<div class="main-container">
    ...
    <div class="middle-container container">
		<header class="block">
					...
					<router-link to="/admin1">
						<li>
							<a class="header-menu-tab" href="#2"><span class="icon  fontawesome-list-alt  scnd-font-color"></span>新闻</a>
						</li>
						</router-link>
						<router-link to="/admin2">
						<li>
							<a class="header-menu-tab" href="#5"><span class="icon fontawesome-exclamation-sign scnd-font-color"></span>举报信息</a>
						</li>
						</router-link>
					</ul>
		</header>
 ...
 <!-- end right-container -->
  ...
  <!--<el-container direction="horizontal">
     <el-card id="card1">
         <el-avatar id="img1" shape="square" :size="70" fit="contain" src="https://fuss10.elemecdn.com/e/5d/4a731a90594a4af544c0c25941171jpeg.jpeg"></el-avatar>
         信息呈现......
         </el-card>
    <div class="container">
      <br>
      <h1 align='left'>账户信息</h1>
      ...
      <br><br><br><br>
      <el-button id="bt_tijiao" type="success" round>提交修改</el-button>
    </div>
...
import JubaoTable from '@/components/jubaoTable.vue'
...
import NewProfilecard from '@/components/newprofilecard.vue'
...
export default {
  name: 'homepage',
  components: {
    adminSidebar,calendardoc,JubaoTable,Uploader,UpdateUser,
    Profilecard,
    HealthReport,
	NewProfilecard,
	CalendarMonth

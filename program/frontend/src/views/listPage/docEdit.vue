    ...
    <header class="block">
                <ul class="header-menu horizontal-list">
                  <router-link to="/homepage">
                    ...
                    <li>
                        <a class="header-menu-tab" href="#5"><span class="icon fontawesome-hospital scnd-font-color"></span>疾病库</a>
                    </li>   
					</router-link>        
                </ul>
...
import JibingTable from '@/components/jibingTable.vue'
...
export default {
  name: 'homepage',
  components: {
    Sidebar,calendardoc,Table,Uploader,UpdateUser,JibingTable,
    Profilecard
  },
}
</script>
